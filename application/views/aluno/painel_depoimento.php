...
<?php echo form_open('Aluno/painel_depoimento') ?>
<div class="row">
    <div class="col-8"> 
    <h1 class="custom-text-primary"> Depoimentos</h1> <br>
        ...
        <div class="col-lg-6">
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <p>Depoimento:<?php echo $alunos[$i]['depoimento'] ? $alunos[$i]['depoimento'] : " - " ?></p>
                </div>
            </div>  
        </div>
            ...
            <div class="col-lg-6">
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        <p>Depoimento:<?php echo $alunos[$i + 1]['depoimento'] ? $alunos[$i]['depoimento'] : " - " ?></p>
                    </div>
                </div>  
            </div>  
        <?php } ?>
